...
const tecnologias: TecnologiaCardProps[] = [
	...
	{
		titulo: "FastAPI",
		imagem: "https://fastapi.tiangolo.com/img/logo-margin/logo-teal.png",
	},
	{
		titulo: "Prisma ORM",
		imagem:
...
export default function Sobre() {
	return (
		<section
			id="sobre"
			className="w-full lg:w-3/4 lg:max-w-screen-lg flex flex-col gap-4 items-center font-inter bg-soft-blue-500"
		>
			<h2 className="w-full text-3xl md:text-center font-bold">Sobre</h2>
			<p className=" text-md text-justify indent-8">
				Olá, meu nome é Yan Campêlo. Sou estudante de Engenharia de Computação
				no SENAI CIMATEC e atualmente estou estagiando na área de automação do
				Cimatec. Estou em constante busca por aprimorar meus conhecimentos e
				ganhar experiência na área de tecnologia, com foco em desenvolvimento de
			...
			<div className="w-full flex flex-col justify-center items-center gap-8">
				...
				<div className="w-full flex flex-wrap justify-center items-end gap-4">
					{tecnologias.map((card: TecnologiaCardProps) => {
						return (
							<TecnologiaCard
								key={card.titulo}
								titulo={card.titulo}
